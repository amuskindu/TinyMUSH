...
extern void pool_err(const char *, int, int, const char *, POOLHDR *, const char *, const char *);
extern void pool_vfy(int, const char *);
extern void pool_check(const char *);
extern char *pool_alloc(int, const char *);
extern void pool_free(int, char **);
extern char *pool_stats(int, const char *);
extern void pool_trace(dbref, int, const char *);
...
extern int sort_memtable(const void *, const void *);
extern void list_rawmemory(dbref);
extern void trace_alloc(size_t, const char *, void *);
extern void trace_free(const char *, void *);
...
extern void register_hashtables(MODHASHES *, MODHASHES *);
extern unsigned int register_dbtype(char *);

/* boolexp.c */
extern int check_attr(dbref, dbref, ATTR *, char *);
extern int eval_boolexp(dbref, dbref, dbref, BOOLEXP *);
extern int eval_boolexp_atr(dbref, dbref, dbref, char *);
extern void skip_whitespace(void);
extern BOOLEXP *test_atr(char *);
extern BOOLEXP *parse_boolexp_L(void);
extern BOOLEXP *parse_boolexp_F(void);
extern BOOLEXP *parse_boolexp_T(void);
extern BOOLEXP *parse_boolexp_E(void);
...
extern DESC *new_connection(int);
extern void shutdownsock(DESC *, int);
extern void make_nonblocking(int);
extern DESC *initializesock(int, struct sockaddr_in *);
extern int process_output(DESC *);
extern int process_input(DESC *);
extern void close_sockets(int, char *);
extern void emergency_shutdown(void);
extern void report(void);
extern void sighandler(int);
extern void set_signals(void);
extern void unset_signals(void);
extern void check_panicking(int);
extern void log_signal(const char *);
...
extern void process_hook(HOOKENT *, int, dbref, dbref, char *[], int);
extern void call_move_hook(dbref, dbref, int);
extern void process_cmdent(CMDENT *, char *, dbref, dbref, int, char *, char *, char *[], int);
extern char *process_command(dbref, dbref, int, char *, char *[], int);
extern void process_cmdline(dbref, dbref, char *, char *[], int, BQUE *);
extern void list_cmdtable(dbref);
extern void list_attrtable(dbref);
extern void helper_list_cmdaccess(dbref, CMDENT *, char *);
extern void list_cmdaccess(dbref);
extern void list_cmdswitches(dbref);
extern void list_attraccess(dbref);
extern void list_attrtypes(dbref);
...
extern void list_df_flags(dbref);
extern void list_costs(dbref);
extern void list_params(dbref);
extern void list_vattrs(dbref);
extern void list_hashstat(dbref, const char *, HASHTAB *);
extern void list_nhashstat(dbref, const char *, HASHTAB *);
extern void list_hashstats(dbref);
extern void list_textfiles(dbref);
extern void list_db_stats(dbref);
extern void list_process(dbref);
extern void list_memory(dbref);
extern void do_list(dbref, dbref, int, char *);

/* conf.c */
extern void cf_init(void);
extern void cf_log_notfound(dbref, char *, const char *, char *);
extern void cf_log_error(dbref, char *, int);
...
extern int cf_status_from_succfail(dbref, char *, int, int);
...
extern int cf_module(int *, char *, long, dbref, char *);
...
extern int cf_infotext(int *, char *, long, dbref, char *);
extern int cf_divert_log(int *, char *, long, dbref, char *);
extern int cf_modify_bits(int *, char *, long, dbref, char *);
extern int modify_xfuncs(char *, int (*)(dbref), EXTFUNCS **, int);
extern int parse_ext_access(int *, EXTFUNCS **, char *, NAMETAB *, dbref, char *);
extern int cf_set_flags(int *, char *, long, dbref, char *);
extern int cf_badname(int *, char *, long, dbref, char *);
extern unsigned long sane_inet_addr(char *);
extern int cf_site(long **, char *, long, dbref, char *);
extern int helper_cf_cf_access(CONF *, dbref, int *, char *, char *, long);
extern int cf_cf_access(int *, char *, long, dbref, char *);
extern int add_helpfile(dbref, char *, char *, int);
extern int cf_helpfile(int *, char *, long, dbref, char *);
extern int cf_raw_helpfile(int *, char *, long, dbref, char *);
extern int cf_include(int *, char *, long, dbref, char *);
extern int helper_cf_set(char *, char *, dbref, CONF *);
extern int cf_set(char *, char *, dbref);
extern void do_admin(dbref, dbref, int, char *, char *);
extern int cf_read(char *);
extern void list_cf_access(dbref);
extern void list_cf_read_access(dbref);
extern void cf_verify(void);
extern void helper_cf_display(dbref, char *, char **, CONF *);
extern void cf_display(dbref, char *, char *, char **);
extern void list_options(dbref);

/* cque.c */
extern void delete_qentry(BQUE *);
...
extern void do_halt_pid(dbref, dbref, int, char *);
extern void do_halt(dbref, dbref, int, char *);
extern int nfy_que(dbref, dbref, int, int, int);
extern void do_notify(dbref, dbref, int, char *, char *);
extern int qpid_next(void);
extern BQUE *setup_que(dbref, dbref, char *, char *[], int, GDATA *);
extern void wait_que(dbref, dbref, int, dbref, int, char *, char *[], int, GDATA *);
extern void do_wait_pid(dbref, int, char *, char *);
extern void do_wait(dbref, dbref, int, char *, char *, char *[], int);
extern int que_next(void);
extern void do_second(void);
extern int do_top(int);
extern void show_que(dbref, int, BQUE *, int *, int *, int *, dbref, dbref, const char *);
extern void do_ps(dbref, dbref, int, char *);
extern void do_queue(dbref, dbref, int, char *);

/* create.c */
extern dbref parse_linkable_room(dbref, char *);
extern void open_exit(dbref, dbref, char *, char *);
extern void do_open(dbref, dbref, int, char *, char *[], int);
extern void link_exit(dbref, dbref, dbref);
extern void do_link(dbref, dbref, int, char *, char *);
extern void do_parent(dbref, dbref, int, char *, char *);
extern void do_dig(dbref, dbref, int, char *, char *[], int);
extern void do_create(dbref, dbref, int, char *, char *);
extern void do_clone(dbref, dbref, int, char *, char *);
extern void do_pcreate(dbref, dbref, int, char *, char *);
extern int can_destroy_exit(dbref, dbref);
extern int destroyable(dbref);
extern int can_destroy_player(dbref, dbref);
extern void do_destroy(dbref, dbref, int, char *);

/* db.c */
extern void tf_xclose(FILE *);
extern int tf_fiddle(int);
extern int tf_xopen(char *, int);
extern const char *mode_txt(int);
...
extern int propdir_ck(int, dbref, dbref, int, char *);
extern PROPDIR *propdir_get(dbref);
extern char *set_string(char **, char *);
...
extern void do_attribute(dbref, dbref, int, char *, char *);
extern void do_fixdb(dbref, dbref, int, char *, char *);
extern void init_attrtab(void);
extern ATTR *atr_str(char *);
extern void anum_extend(int);
extern ATTR *atr_num(int);
extern int mkattr(char *);
extern int al_decode(char **);
extern void al_code(char **, int);
extern int Commer(dbref);
extern void al_extend(char **, int *, int, int);
extern int al_size(char *);
extern void al_store(void);
extern char *al_fetch(dbref);
extern void al_add(dbref, int);
extern void al_delete(dbref, int);
extern void makekey(dbref, int, Aname *);
extern void al_destroy(dbref);
extern char *atr_encode(char *, dbref, dbref, int, int);
extern void atr_decode(char *, char *, dbref, dbref *, int *, int, int *);
...
extern void atr_set_flags(dbref, int, dbref);
...
extern void initialize_objects(dbref, dbref);
